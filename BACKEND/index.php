...
<text y='0.9em' font-size='400'>💿</text>
  ...
  <!-- ✅ CORREGIDO: Ruta relativa al CSS -->
  ...
  <header class="main-header">
    <div class="container-fluid d-flex align-items-center justify-content-between py-2 px-4">
      <div class="d-flex align-items-center">
        ...
        <img src="https://tienda-vinilo-daw.vercel.app/imagenes/VinylLab.png" alt="Logo Vinyl Lab" class="header-logo me-2" style="height: 50px;">
    ...
    <section class="hero d-flex flex-column flex-lg-row align-items-center justify-content-between mb-5 gap-5">
      ...
      <div class="hero-left text-center text-lg-start position-relative">
        <div class="imagen position-relative d-inline-block mb-3">
          <img src="https://tienda-vinilo-daw.vercel.app/imagenes/beatles1.jpg" alt="Vinilo destacado" class="imagen-principal">
    ...
    <section class="info-tienda">
      <div class="row align-items-center">
        <div class="col-lg-6 mb-4 mb-lg-0">
          <img src="https://tienda-vinilo-daw.vercel.app/imagenes/vinylstore1.png" alt="Vinyl store" class="img-fluid rounded shadow">
        </div>
        <div class="col-lg-6">
    ...
    <div class="container">
      <div class="row gy-4">
        <div class="col-md-3 text-center text-md-start">
          <img src="https://tienda-vinilo-daw.vercel.app/imagenes/VinylLab.png" alt="Logo Vinyl Lab" class="footer-logo mb-2">
